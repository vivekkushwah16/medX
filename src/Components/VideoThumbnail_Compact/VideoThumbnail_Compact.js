        ...
        <div className="maincardBox__card maincardBox__card--large">
            <div className="maincardBox__card-menu">
                ...
                <ul className="maincardBox__card-menu-dropdown">
                    <li><a onClick={()=>openVideoPop(currentVideoData,videosData)}>Watch this video</a></li>
                </ul>
            </div>
            <div className="maincardBox__card-left">
                <div className="maincardBox__card-video" onClick={()=>openVideoPop(currentVideoData,videosData)} style={{ backgroundImage: `url(${currentVideoData.thumnailUrl})` }}>
            ...
            <div className="maincardBox__card-right">
                <h4 className="mg-b15 maincardBox__card-title" onClick={()=>openVideoPop(currentVideoData,videosData)}>{currentVideoData.title}</h4>
