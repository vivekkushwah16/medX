...
function VideoThumbnail_Compact(props) {
  ...
  return (
    <>
      <div
        className="videoThumbnailContainer mg-b20"
        onClick={() => {
          // console.log("working?");
      ...
      >
        ...
        <div>
          <h4 className="mg-b15 maincardBox__card-title">
          ...
          <p className="mg-b25 maincardBox__card-desc">
            {currentVideoData.description.substr(0, characterLimit)}...&nbsp;{" "}
          </p>
        </div>
      </div>
    </>
  ...
  return (
    <div className="maincardBox__card maincardBox__card--large">
      ...
      <div className="maincardBox__card-left">
        ...
        >
          <a
            ...
            className="maincardBox__card-video__play"
          >
      ...
      <div className="maincardBox__card-right">
        <h4
          className="mg-b15 maincardBox__card-title"
          onClick={() => {
            // console.log("working?");
            openVideoPop(currentVideoData, videosData);
          }}
