        ...
        [
            {
                ...
                "thumnailUrl": "https://firebasestorage.googleapis.com/v0/b/cipla-impact.appspot.com/o/impact2021%2Fvideo%2FDr%20Richard.png?alt=media&token=2e378ee6-41dd-4d2e-af5f-8bf52633cc5f",
                "id": "video-koy0esx2",
                "timestamp": 1621582599171,
                "videoTimestamp": [
                    {
                        "title": "Introduction & early observation of respiratory aliments with COVID-19",
                        "startTime": 8,
                        "endTime": 244
                    },
                    {
                        "startTime": 244,
                        "title": "Can inhaled corticosteriods stop COVID-19 getting worse? (STOIC Study)",
                        "endTime": 456
                    },
                    {
                        "endTime": 563,
                    ...
                    {
                        "endTime": 970,
                        "title": "Inhaled budesonide for elderly COVID-19 patients: Interim analysis from the PRINCIPLE trial",
                        "startTime": 879
                    },
                    {
                        "startTime": 970,
...
export default function SearchPage() {
    ...
    const doQuery = useCallback(
        () => {
            ...
            let newURL = `${SEARCH_ROUTE}?keyword=${encodeURIComponent(lastQuery.current)}`
    ...
    useMemo(() => {
        let exec = (_urlQuery) => {
            ...
            if (_filter) {
                _filter = _urlQuery.get("filter").split(",").map(item => decodeURIComponent(item))
                setFilterBy(_filter)
            }
