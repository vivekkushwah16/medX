...
let firebaseConfig = {
  apiKey: "AIzaSyA5SBC25jr9_89XfhiuJmmhHW5EBfQIqSo",
  authDomain: "hero-virtual.firebaseapp.com",
  databaseURL: "https://hero-virtual-default-rtdb.firebaseio.com",
  projectId: "hero-virtual",
  storageBucket: "hero-virtual.appspot.com",
  messagingSenderId: "300525819087",
  appId: "1:300525819087:web:5a222bac8f7bf7d9f093ba",
  measurementId: "G-ZX5SNLV8B1"
};
// Initialize Firebase
...
auth.onAuthStateChanged(function (user) {
  if (user) {
    ...
    eid = "djunknown@digialjalebi.com";
    auth.signInWithEmailAndPassword("guest@digitaljalebi.com", "123456789").then((cred) => {
...
function paintToCanvas() {
  ...
  return setInterval(() => {
    if (!Pause) {
      ...
      if (mobile) {
        ctx.drawImage(video, 76 + findExtaW, 339 + findExtaH, reObj.width + 195, reObj.height + 590);
      }
      else {
        ctx.fillRect(569, 256, 732, 473);
        ctx.drawImage(video, 570 + findExtaW, 257 + findExtaH, reObj.width, reObj.height);
...
function UploadImage(file) {
  ...
  var storageRef = storage.ref('phootobooth/' + eid + "_" + timestamp + ".jpeg")
